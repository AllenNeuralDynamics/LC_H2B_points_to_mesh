...
- **`.brainglobe`**: the public brainglobe [`allen_mouse_25um`](https://brainglobe.info/documentation/brainglobe-atlasapi/usage/atlas-details.html) atlas; its whole-brain root mesh (`meshes/997.obj`) is used only as the brain-outline backdrop in the 3D figures.
